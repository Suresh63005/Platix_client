    ...
    <div className="flex flex-col md:flex-row justify-between items-center p-4 space-y-4 md:space-y-0">
      ...
      <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
        ...
        <FilterDropdown
          ...
          onFilterChange={onFilterChange}  // Ensure this is passed down correctly
          options={options}
          placeholder={filterPlaceholder} // Pass placeholder for filter dropdown
          className="p-2 pl-2 border filter rounded w-[100px] h-[40px] text-[12px] shadow-md  focus:border-2 focus:ring-[#660F5D] focus:border-[#660F5D] focus:outline-none"
        />
